...
- **`000_apply_all_optional_columns.sql`** – Use this on an **existing** database to add any missing columns (e.g. `inventory_items.category`, `quick_scans.movement_type`). Safe to run more than once.
